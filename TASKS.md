...
<!-- Format: - [ ] **Task** | due: MM/DD | est: Xhr | Notes -->
<!-- Priority tasks are marked with [!] and sorted to the top -->
...
- [ ] **Check in with Hannah on Matt's survey responses + workshop date** | due: TBD | est: 30min | Targeting next week for workshop
- [ ] **CE brand refresh: Document rollout strategy by channel** | due: TBD | est: 2hr | Map out content needed, share with Tony, pass to creative team. Originally due 4/9.
- [ ] **Review BE business exec audit doc** | due: TBD | est: 2hr | Identify first clients to build knowledge bases for (Red Gold is priority #1)
